...
from pytlas.understanding import Intent, SlotValue, SlotValues, UnitValue
...
try:
  ...
  fitted_interpreter.fit_from_file(os.path.join(os.path.dirname(__file__), '../__training.json'))

  cached_interpreter = SnipsInterpreter('en', os.path.join(os.path.dirname(__file__), '../__snips_interpreter_cache'))
